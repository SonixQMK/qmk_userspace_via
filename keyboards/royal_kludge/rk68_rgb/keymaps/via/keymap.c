...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WINFN] = LAYOUT_65_ansi(
        _______,    KC_BRIU,    KC_BRID,    KC_TASK,    KC_FLXP,    RM_VALD,    RM_VALU,    KC_MPRV,    KC_MPLY,    KC_MNXT,    KC_MUTE,    KC_VOLD,    KC_VOLU,    _______,     KC_PSCR,
        _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_HOME,    KC_END,     RM_NEXT,     KC_INS,
        _______,    _______,    RK_MAC,     _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,                _______,     KC_PAUS,
        _______,                _______,    _______,    _______,    _______,    _______,    _______,    _______,    RM_HUEU,    _______,    _______,    MO(FNS),    RM_VALU,     KC_SCRL,
        QK_BOOT,    _______,    _______,                                        _______,                            _______,    _______,    _______,    RM_SPDD,    RM_VALD,     RM_SPDU
    ),
    /* Mac Base
     * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───────┬───┐
     * │Esc│ 1 │ 2 │ 3 │ 4 │ 5 │ 6 │ 7 │ 8 │ 9 │ 0 │ - │ = │ Backsp│`~ │
    ...
    [MACFN] = LAYOUT_65_ansi(
        _______,    KC_BRIU,    KC_BRID,    KC_MCTL,    KC_LPAD,    RM_VALD,    RM_VALU,    KC_MPRV,    KC_MPLY,    KC_MNXT,    KC_MUTE,    KC_VOLD,    KC_VOLU,    _______,    KC_PSCR,
        _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_HOME,    KC_END,     RM_NEXT,    KC_INS,
    ...
    [FNS] = LAYOUT_65_ansi(
        ...
        _______,    _______,    _______,                                        _______,                            _______,    _______,    _______,    _______,    RM_SATD,    _______
    )
};
